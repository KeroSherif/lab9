...
public class SudokuBoardManager {
    ...
    public static int[][] loadBoard(String filePath) throws Exception {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (parts.length != 9) {
                    throw new IllegalArgumentException(
                        "Each row must have 9 values, found: " + parts.length
                    );
                }
                ...
                for (int i = 0; i < 9; i++) {
                    ...
                    // ALLOW 0..9 (0 for empty cells)
                    if (val < 0 || val > 9) {
                        throw new IllegalArgumentException(
                            "Values must be between 0 and 9, found: " + val
                        );
                    }
        ...
        if (rows.size() != 9) {
            throw new IllegalArgumentException(
                "Sudoku must have exactly 9 rows, found: " + rows.size()
            );
        }
